...
(function() {
  $(function() {
    $(document).on("click", ".abil_form_check_all", function() {
      var targ;
      targ = $(this).attr("id");
      if (this.checked) {
    ...
    $(document).on("click", ".ability", function() {
      var abil;
      abil = $(this).attr("id");
      return $("#" + abil + "-save").show();
    });
    return $(document).on("click", ".row-2-on, .add-rem-effects-on, .show-jobs-on, .show-edit-effects-on, .change-jobs-on, .edit-images-on", function() {
      var targ;
      targ = $(this).attr("id");
      return $("." + targ).show();
    });
...
(function() {
  window.fixEvolMon = function(monster, player) {
    monster.isAlive = function() {
      if (this.hp <= 0) {
        setTimeout((function() {
          $("." + monster.team + " " + ".mon" + monster.index + " " + ".hp .bar").css({
            "width": "0%"
          });
          return $("." + monster.team + " " + ".mon" + monster.index + " " + ".effect-box").fadeOut(300).remove();
        }), 750);
        return false;
      } else {
        return true;
    ...
    monster.useAbility = function(abilityIndex, abilityTargets) {
      var ability;
      ability = this.abilities[abilityIndex];
      return ability.use(abilityTargets);
    };
    return $(monster.abilities).each(function() {
      var a, ability;
      this.team = monster.team;
      this.index = monster.index;
      ability = this;
      a = this;
      ability.use = function(abilitytargets) {
        var e, effect, effectTargets, i, i3, ii, index, monTarget, n, targets, _results;
        if (a.targeta.indexOf("aoe") !== -1 && findObjectInArray(monster.cursed, "targeta", "aoe-curse") > 0) {
          e = usefulArray[0];
          monster[e.stat] = eval(monster[e.stat] + e.modifier + e.change);
        } else if ((a.targeta.indexOf("ally") !== -1 || a.targeta.indexOf("cleanse") !== -1) && findObjectInArray(monster.cursed, "targeta", "help-curse") > 0) {
          e = usefulArray[0];
          monster[e.stat] = eval(monster[e.stat] + e.modifier + e.change);
        } else if (a.targeta.indexOf("attack") !== -1 && findObjectInArray(monster.cursed, "targeta", "atk-curse") > 0) {
          e = usefulArray[0];
          monster[e.stat] = eval(monster[e.stat] + e.modifier + e.change);
        }
        a = this;
        ...
        while (i < abilitytargets.length) {
          ...
          if (monTarget.isAlive()) {
            if (a.targeta === "cleanseally" || a.targeta === "aoecleanse") {
              ii = 0;
              while (ii < monTarget.poisoned.length) {
                e = monTarget.poisoned[ii];
                if (e.impact.indexOf("-") !== -1) {
                  delete monTarget.poisoned(ii);
                }
              ...
              while (i3 < monTarget.weakened.length) {
                ...
                if (e.restore.indexOf("+") !== -1) {
                  delete monTarget.weakened[i3];
                }
                removeEffectIcon(monTarget, e);
                i3++;
              }
            ...
            } else if (a.modifier === "-" && a.targeta === "attack") {
              window["change" + index] = eval(a.change - monTarget["phy_resist"]);
              if (window["change" + index].toString().indexOf("-") !== -1) {
                window["change" + index] = 0;
              }
              monTarget[a.stat] = eval(monTarget[a.stat] + a.modifier + window["change" + index]);
            } else if (a.modifier === "-" && (a.targeta === "targetenemy" || a.targeta === "aoeenemy")) {
              ...
              window["change" + index] = a.change;
              monTarget[a.stat] = eval(monTarget[a.stat] + a.modifier + window["change" + index]);
              if (typeof monTarget.isAlive !== "undefined") {
                monTarget.isAlive();
              }
            }
          }
        ...
        if (ability.effects.length !== 0) {
          ...
          while (i < ability.effects.length) {
            ...
            switch (effect.targeta) {
              case "taunt":
              case "poison-hp":
              case "timed-phy-resist-buff":
              case "timed-phy-resist-debuff":
              case "timed-spe-resist-buff":
              case "timed-spe-resist-debuff":
              case "shield":
              case "curse-aoe":
              ...
              case "tworandomfoes":
                ...
                if (typeof liveFoes[1] !== "undefined") {
                  effectTargets.push(liveFoes[1]);
                }
              ...
              case "tworandommons":
                ...
                if (typeof liveMons[1] !== "undefined") {
                  effectTargets.push(liveMons[1]);
                }
                effect.activate(effectTargets);
                break;
              case "foebuffattack":
                ...
                effect.activate(effectTargets);
                break;
              case "tworandomallies":
                effectTargets = [];
                findAliveFriends();
                effectTargets.push(liveFriends[0]);
                if (typeof liveFriends[1] !== "undefined") {
                  effectTargets.push(liveFriends[1]);
                }
                effect.activate(effectTargets);
            }
            _results.push(i++);
      ...
      return $(ability.effects).each(function() {
        this.monDex = monster.index;
        this.teamDex = monster.team;
        this.name = this.name.replace(/\s+/g, '');
        return this.activate = function(effectTargets) {
          var e, i, monTarget, old_effect, status, _results, _results1, _results2, _results3, _results4, _results5;
          e = this;
          i = 0;
          if (e.targeta.indexOf("curse") !== -1) {
            _results = [];
            ...
            return _results;
          } else if (e.targeta.indexOf("shield") !== -1) {
            _results1 = [];
            while (i < effectTargets.length) {
              monTarget = effectTargets[i];
              if (monTarget.isAlive()) {
                if (monTarget.shield.end === void 0) {
                  addEffectIcon(monTarget, e);
                } else {
            ...
            return _results1;
          } else if (e.targeta.indexOf("taunt") !== -1) {
            _results2 = [];
            while (i < effectTargets.length) {
              monTarget = effectTargets[i];
              if (monTarget.isAlive()) {
                if (monTarget.taunted.end === void 0) {
                  addEffectIcon(monTarget, e);
                } else {
                  removeEffectIcon(monTarget, e);
                  addEffectIcon(monTarget, e);
            ...
            return _results2;
          } else if (e.targeta.indexOf("poison") !== -1) {
            _results3 = [];
            while (i < effectTargets.length) {
              monTarget = effectTargets[i];
              monTarget[e.stat] = eval(monTarget[e.stat] + e.modifier + e.change);
              if (monTarget.shield.end !== "undefined") {
                monTarget.shield.true_damage += parseInt(e.change);
              }
              checkMin();
              checkMax();
              if (typeof monTarget.isAlive !== "undefined") {
            ...
            return _results3;
          } else if (e.targeta.indexOf("timed") !== -1) {
            _results4 = [];
            while (i < effectTargets.length) {
              monTarget = effectTargets[i];
  ...
  window.findObjectInArray = function(array, field, value) {
    var i;
    window.usefulArray = [];
    i = 0;
    while (i < array.length) {
      if (typeof array[i] !== "undefined") {
        if (typeof array[i][field] !== "undefined") {
          if (array[i][field].indexOf(value) !== -1) {
  ...
  window.isTeamDead = function(monster, index, array) {
    return monster.isAlive() === false;
  };

  window.isTurnOver = function(object, index, array) {
    return object.turn === false;
  };

  window.noApLeft = function(object, index, array) {
    return $(object).data("apcost") > battle.players[0].ap;
  };

  window.nothingToDo = function(object, index, array) {
    return $(object).css("opacity") === "0";
  };

  window.setAll = function(array, attr, value) {
    var i, n;
    n = array.length;
    i = 0;
    while (i < n) {
  ...
  window.fixHp = function() {
    var i, n, _results;
    n = playerMonNum;
    i = 0;
    while (i < n) {
      battle.players[0].mons[i].hp = (battle.players[0].mons[i].hp < 0 ? 0 : battle.players[0].mons[i].hp);
      i++;
    }
    n = pcMonNum;
    i = 0;
    _results = [];
    while (i < n) {
      battle.players[1].mons[i].hp = (battle.players[1].mons[i].hp < 0 ? 0 : battle.players[1].mons[i].hp);
      _results.push(i++);
    }
    return _results;
  };

  window.checkMax = function() {
    var i, mon, _results;
    i = 0;
    while (i < playerMonNum) {
      mon = battle.players[0].mons[i];
      if (mon.hp > mon.max_hp) {
        battle.players[0].mons[i].hp = mon.max_hp;
      }
      i++;
    }
    i = 0;
    ...
    while (i < pcMonNum) {
      ...
      if (mon.hp > mon.max_hp) {
        battle.players[1].mons[i].hp = mon.max_hp;
      }
      _results.push(i++);
    }
    return _results;
  ...
  window.checkMin = function() {
    ...
    while (i < playerMonNum) {
      mon = battle.players[0].mons[i];
      if (mon.hp === 0) {
        battle.players[0].mons[i].max_hp = 0;
      }
      i++;
    }
    i = 0;
    ...
    while (i < pcMonNum) {
      mon = battle.players[1].mons[i];
      if (mon.hp === 0) {
        battle.players[1].mons[i].max_hp = 0;
      }
      _results.push(i++);
    }
    return _results;
  ...
  window.multipleAction = function() {
    xadBuk();
    checkMin();
  ...
  window.userMon = function(index) {
    return $(".user .mon" + index + " " + ".img");
  };

  window.pcMon = function(index) {
    return $(".enemy .mon" + index + " " + ".img");
  };

  window.numOfDeadFoe = function() {
    var i, n, num;
    num = 0;
    n = pcMonNum;
    i = 0;
    while (i < n) {
      if (battle.players[1].mons[i].isAlive() === false) {
        num += 1;
      }
      i++;
    }
  ...
  window.checkEnemyDeath = function(index) {
  ...
  window.findAliveEnemies = function() {
    var i, n;
    window.liveFoes = [];
    n = pcMonNum;
    i = 0;
    while (i < n) {
      if (battle.players[0].enemies[i].isAlive() === true) {
        liveFoes.push(battle.players[0].enemies[i]);
      }
      i++;
    }
    return shuffle(liveFoes);
  };

  window.findAliveFriends = function() {
    var i, n;
    window.liveFriends = [];
    n = playerMonNum;
    i = 0;
    while (i < n) {
      if (battle.players[0].mons[i].isAlive() === true) {
        liveFriends.push(battle.players[0].mons[i]);
      }
      i++;
    }
    return shuffle(liveFriends);
  };

  window.findAliveMons = function() {
    window.liveMons = liveFriends.concat(liveFoes);
    return shuffle(window.liveMons);
  };

  window.randomNumRange = function(max, min) {
    return Math.floor(Math.random() * (max - min) + min);
  };

  window.enemyTimer = function() {
    window.timer1 = 0;
    if (checkEnemyDeath(1) === true) {
      window.timer3 = 0;
    } else {
      window.timer3 = 2500;
    }
    if (checkEnemyDeath(1) === true && checkEnemyDeath(3) === true) {
      window.timer2 = 0;
    } else if (checkEnemyDeath(1) === true || checkEnemyDeath(3) === true) {
      window.timer2 = 2500;
    } else {
      window.timer2 = 5000;
    }
    if (checkEnemyDeath(1) && checkEnemyDeath(3) && checkEnemyDeath(2)) {
      window.timer0 = 0;
    } else if (((checkEnemyDeath(1) && checkEnemyDeath(2)) || (checkEnemyDeath(1) && checkEnemyDeath(3))) || (checkEnemyDeath(2) && checkEnemyDeath(3))) {
      window.timer0 = 2500;
    ...
    switch (numOfDeadFoe()) {
      case 0:
        return window.timerRound = 10000;
      case 1:
        return window.timerRound = 7500;
      case 2:
        return window.timerRound = 5000;
      case 3:
        return window.timerRound = 2500;
      case 4:
        return window.timerRound = 0;
    }
  };

  window.callAbilityImg = function() {
    return battle.players[targets[0]].mons[targets[1]].abilities[targets[2]].img;
  };

  window.barChange = function(current, max) {
    return {
  ...
  window.apInfo = function(maxAP) {
    return "AP:" + "   " + maxAP + " / " + maxAP;
  };

  window.apAfterUse = function(current, max) {
    return "AP:" + "   " + current + " / " + max;
  };

  window.apChange = function() {
    $(apNum).text(apAfterUse(battle.players[0].ap, battle.maxAP));
    return $(apBar).css(barChange(battle.players[0].ap, battle.maxAP));
  };

  window.hpChange = function(side, index) {
    return "." + side + " " + ".mon" + index + " " + ".current-hp";
  };

  window.maxHpChange = function(side, index) {
    return "." + side + " " + ".mon" + index + " " + ".max-hp";
  };

  window.hpBarChange = function(side, index) {
    return "." + side + " " + ".mon" + index + " " + ".hp .bar";
  };

  window.hpChangeBattle = function() {
    var i, n, _results;
    n = playerMonNum;
    i = 0;
    while (i < n) {
      if (battle.players[0].mons[i].hp.toString() !== $(".user" + " " + ".mon" + i + " " + ".current-hp").text()) {
    ...
    _results = [];
    while (i < n) {
      if (battle.players[1].mons[i].hp.toString() !== $(".user" + " " + ".mon" + i + " " + ".current-hp").text()) {
  ...
  window.damageBoxAnime = function(team, target, damage, color) {
    return $("." + team + " " + ".mon" + target + " " + "p.dam").text(damage).animate({
      "color": color,
      "font-weight": "bold"
    }, 1).fadeIn(1).animate({
      "top": "-=50px",
      ...
      return setTimeout((function() {
        return $(".img, .ability-img, .single-ability-img").promise().done(function() {
          return $(".img, .ability-img, .single-ability-img, p.dam").promise().done(function() {
            return setTimeout((function() {
              return $("p.dam").promise().done(function() {
                return outcome();
              });
            }), 250);
          });
  ...
  window.showDamageSingle = function() {
    return damageBoxAnime(enemyHurt.team, enemyHurt.index, ability.modifier + window["change" + enemyHurt.index], "rgba(255, 0, 0)");
  };

  window.showHealSingle = function() {
    return damageBoxAnime(allyHealed.team, allyHealed.index, ability.modifier + window["change" + allyHealed.index], "rgba(50,205,50)");
  };

  window.showDamageTeam = function(index) {
    var i, n, _results;
    i = void 0;
    n = void 0;
  ...
  window.showHealTeam = function(index) {
    var i, n, _results;
    i = void 0;
    n = void 0;
    n = battle.players[index].mons.length;
  ...
  window.outcome = function() {
    if (battle.players[0].mons.every(isTeamDead) === true) {
      vitBop();
      toggleImg();
      document.getElementById('battle').style.pointerEvents = 'none';
      $(".message").text("You lost, but here's " + battle.reward * 0.1 + " MP because we pity you, not. Try harder next time!").append("<br/><br/><a href='/battles/new' class='btn btn-danger'>Avenge your time</a>").css("opacity", 1);
      setTimeout((function() {
        return $(".btn.btn-danger").addClass("battle-fin");
      }), 250);
      $("#overlay").fadeIn(1000);
      return setTimeout((function() {
        return $.ajax({
    ...
    } else if (battle.players[1].mons.every(isTeamDead) === true) {
      vitBop();
      toggleImg();
      document.getElementById('battle').style.pointerEvents = 'none';
      ...
      $(document).on("click.cutscene", "#overlay", function() {
        var new_index;
        if ($(".cutscene").attr("src") === battle.end_cut_scenes[battle.end_cut_scenes.length - 1]) {
          $(".message").text("You won" + " " + battle.reward + " " + "MP! " + "Go kill more monsters!").append("<br/><br/><a href='/battles/new' class='btn btn-success battle-fin'>Continue your journey</a>");
          $(".cutscene").hide(500);
          endCutScene();
          return setTimeout((function() {
            $(".btn.btn-success").addClass("battle-fin");
            return $(".message").css("opacity", "1");
          }), 500);
        } else {
      ...
      if (battle.end_cut_scenes.length !== 0) {
        $(".cutscene").attr("src", battle.end_cut_scenes[0]);
        $(".cutscene").css("opacity", "1");
        $("#overlay").fadeIn(1000);
        return nextSceneInitial();
      } else {
        $(".message").text("You won" + " " + battle.reward + " " + "MP! " + "Go kill more monsters!").append("<br/><br/><a href='/battles/new' class='btn btn-success'>Continue your journey</a>");
        $(".message").css("opacity", "1");
        $(".cutscene, .next-scene").css("opacity", "0");
        $(".message").promise().done(function() {
          $(".btn.btn-success").addClass("battle-fin");
          return $("#overlay").fadeIn(1000);
        });
        return $(document).off("click.cutscene", "#overlay");
      }
    }
  };

  window.checkApAvailbility = function() {
    return $(".monBut button").each(function() {
  ...
  window.checkMonHealthAfterEffect = function() {
    var i, n, _results;
    fixHp();
    i = 0;
    n = playerMonNum;
    while (i < n) {
      if (battle.players[0].mons[i].hp <= 0) {
        $(".0 .mon" + i + " " + ".img").fadeOut(500);
      }
      i++;
    }
    i = 0;
    ...
    _results = [];
    while (i < n) {
      if (battle.players[1].mons[i].hp <= 0) {
        $(".1 .mon" + i + " " + ".img").fadeOut(500);
      }
      _results.push(i++);
    }
    return _results;
  ...
  window.addEffectIcon = function(monster, effect) {
    var e, index;
    e = Object.create(effect);
    if (effect.targeta === "taunt") {
      e.target = battle.players[effect.teamDex].mons[effect.monDex].name;
    }
    ...
    $("<img src = '" + effect.img + "' class = 'effect " + monster.name + " " + effect.name + " " + effect.targeta + "' id='" + index + "' >").prependTo("." + monster.team + " " + ".mon" + monster.index + " " + ".effect-box").addClass("tada animated");
    return setTimeout((function() {
      return $(".tada.animated").removeClass("tada animated");
    }), 1000);
  };

  window.removeEffectIcon = function(monster, effect) {
    return $("." + monster.team + " " + ".mon" + monster.index + " " + "." + effect.targeta).fadeOut(400, function() {
      return $(this).trigger("mouseleave").remove();
    });
  };

  window.massRemoveEffectIcon = function(effect) {
    return $("." + effect.targeta).fadeOut(400, function() {
      return $(this).trigger("mouseleave").remove();
    });
  };

  window.battleStartDisplay = function(time) {
    $(".message").css("opacity", "0");
    setTimeout((function() {
  ...
  window.singleTargetAbilityAfterClickDisplay = function(ability) {
    turnOff("click.boom", ".enemy");
    turnOff("click.help", ".user");
    $(document).off("click.cancel", ".cancel");
    $(".user .img").removeClass("controlling");
    return $(".battle-guide").hide();
  };

  window.singleTargetAbilityAfterActionDisplay = function() {
    apChange();
    hpChangeBattle();
    ...
    return flashEndButton();
  };

  window.allyAbilityBeforeClickDisplay = function() {
  ...
  window.enemyAbilityBeforeClickDisplay = function() {
    $(".battle-guide.guide").text("Select an enemy target to activate");
    $(".battle-guide").show();
    toggleEnemyClick();
    return turnOffCommandA();
  };

  window.singleTargetAbilityDisplayVariable = function() {
    window.enemyHurt = battle.players[targets[0]].enemies[targets[3]];
    window.monsterUsed = battle.players[targets[0]].mons[targets[1]];
    return window.ability = battle.players[targets[0]].mons[targets[1]].abilities[targets[2]];
  };

  window.singleHealTargetAbilityDisplayVariable = function() {
    window.allyHealed = battle.players[targets[0]].mons[targets[3]];
    window.monsterUsed = battle.players[targets[0]].mons[targets[1]];
    return window.ability = battle.players[targets[0]].mons[targets[1]].abilities[targets[2]];
  };

  window.multipleTargetAbilityDisplayVariable = function() {
    window.ability = battle.players[targets[0]].mons[targets[1]].abilities[targets[2]];
    return window.monsterUsed = battle.players[targets[0]].mons[targets[1]];
  };

  window.endCutScene = function() {
    $(document).off("click.cutscene", "#overlay");
    $(".cutscene").css("opacity", "0");
    return $(".next-scene").css("opacity", "0");
  };

  window.nextSceneInitial = function() {
    document.getElementById('overlay').style.pointerEvents = 'none';
    return setTimeout((function() {
      $(".next-scene").css("opacity", "0.9");
      return document.getElementById('overlay').style.pointerEvents = 'auto';
    }), 1000);
  };
  ...
  window.nextScene = function() {
    ...
    setTimeout((function() {
      return $(".cutscene").attr("src", new_scene);
    }), 300);
    setTimeout((function() {
      return $(".cutscene").css("opacity", "1");
    }), 800);
    return setTimeout((function() {
      $(".next-scene").css("opacity", "0.9");
      if (document.getElementById('overlay') !== null) {
  ...
  window.mouseOverMon = function() {
    ...
    window.targets = [team, mon];
  };

  window.mouseLeaveMon = function() {
    $(".user .monBut").css({
      "opacity": "0",
      "visibility": "hidden"
    });
    return $(".user .img").removeClass("controlling");
  };

  window.turnOnCommandA = function() {
    $(document).on("mouseleave.command", ".user.mon-slot .mon", mouseLeaveMon);
    return $(document).on("mouseover.command, mousemove.command", ".user.mon-slot .img", mouseOverMon);
  };

  window.turnOffCommandA = function() {
    $(document).off("mouseleave.command", ".user.mon-slot .mon", mouseLeaveMon);
    return $(document).off("mouseover.command, mousemove.command", ".user.mon-slot .img", mouseOverMon);
  };

  window.turnOff = function(name, team) {
    return $(document).off(name, team + ".mon-slot .img");
  };

  window.disable = function(button) {
    button.attr("disabled", "true");
    return button.css("opacity", 0);
  };

  window.enable = function(button) {
    button.removeAttr("disabled");
    return button.css("opacity", 1);
  };

  window.toggleImg = function() {
    return $(".user .img").each(function() {
  ...
  window.flashEndButton = function() {
    window.buttonArray = [];
    $(".end-turn").prop("disabled", false);
    $(".monBut button").each(function() {
      if ($(this).parent().parent().children(".img").css("display") !== "none" && $(this).attr("disabled") !== "disabled") {
        return buttonArray.push($(this));
      }
    });
  ...
  window.toggleEnemyClick = function() {
    return $(".enemy .img").each(function() {
      if ($(this).attr("disabled") === "disabled") {
  ...
  window.roundEffectHappening = function(team) {
    var e, i, i3, i4, ii, mon, n, n3, n4, nn, shieldy, _results;
    $("." + team + " " + ".effect-box").addClass("rubberBand animated");
    setTimeout((function() {
      return $("." + team + " " + ".effect-box").removeClass("rubberBand animated");
    }), 500);
    i = 0;
    ...
    while (i < n) {
      ...
      if (mon.isAlive()) {
        if (typeof mon.shield.end !== "undefined") {
          shieldy = parseInt(mon.shield.extra_hp) + mon.shield.true_damage - (mon.shield.old_hp - mon.hp);
          if (battle.round === mon.shield.end || (mon.shield.old_hp - (mon.hp + mon.shield.true_damage)) > mon.shield.extra_hp) {
            removeEffectIcon(mon, mon.shield);
            mon.shield.end = void 0;
        ...
        if (mon.taunted.target !== void 0) {
          if (battle.round === mon.taunted.end || battle.players[0].mons[mon.taunted.target].hp <= 0) {
            removeEffectIcon(mon, mon.taunted);
            mon.taunted.target = void 0;
          }
        }
        if (mon.poisoned.length !== 0) {
          ii = 0;
          nn = mon.poisoned.length;
          while (ii < nn) {
            e = mon.poisoned[ii];
            if (typeof e !== "undefined") {
              if (battle.round === e.end) {
                ...
                checkMin();
                checkMax();
                if (typeof mon.isAlive !== "undefined") {
                  mon.isAlive();
                }
              }
              if (e.targeta.indexOf("poison") !== -1) {
  ...
  window.findTargetsBelowPct = function(pct) {
    var i, n, _results;
    i = void 0;
    n = void 0;
    n = playerMonNum;
    ...
    _results = [];
    while (i < n) {
      if (battle.players[0].mons[i].hp / battle.players[0].mons[i].max_hp <= pct && battle.players[0].mons[i].hp > 0) {
  ...
  window.findTargetsAbovePct = function(pct) {
    var i, n, _results;
    i = void 0;
    n = void 0;
    n = playerMonNum;
  ...
  window.findTargets = function(hp) {
    var i, n, _results;
    i = void 0;
    n = void 0;
    n = playerMonNum;
    ...
    _results = [];
    while (i < n) {
      if (battle.players[0].mons[i].hp <= hp && battle.players[0].mons[i].hp > 0) {
        aiTargets.push(battle.players[0].mons[i].index);
      }
      _results.push(i++);
    }
  ...
  window.totalUserHp = function() {
    var i, n, totalCurrentHp;
    i = void 0;
    n = void 0;
    totalCurrentHp = 0;
    n = playerMonNum;
  ...
  window.feedAiTargets = function() {
    if (battle.round > 5 && teamPct() > 0.6) {
      ...
      if (aiTargets.length === 0) {
        return findTargetsAbovePct(0.3);
      }
    } else if (teamPct() <= 0.4 && teamPct() > 0.2) {
      window.aiAbilities = [2, 3];
      findTargets(1800);
      if (aiTargets.length === 0) {
        return findTargets(3500);
      }
    } else if (teamPct() <= 0.2) {
  ...
  window.controlAI = function(monIndex) {
    var ability, abilityAnime, abilityIndex, backPosition, currentMon, currentPosition, index, leftMove, monster, targetMon, targetPosition, topMove;
    xadBuk();
    monster = battle.players[1].mons[monIndex];
    if (monster.hp > 0) {
      $(".battle-message").text(monster.name + ":" + " " + getRandom(monster.speech)).effect("highlight", 500);
      abilityIndex = getRandom(aiAbilities);
      if (monster.taunted.target === void 0 || parseInt(battle.players[0].mons[monster.taunted.target].hp) <= 0) {
      ...
      switch (ability.targeta) {
        case "attack":
          ...
          setTimeout((function() {
            if (targetMon.css("display") !== "none") {
              if (enemyHurt.isAlive() === false) {
            ...
            return currentMon.finish().animate(backPosition, 540);
          }), 560);
          return setTimeout((function() {
            showDamageSingle();
            hpChangeBattle();
        ...
        case "targetenemy":
          ...
          return abilityAnime.finish().attr("src", callAbilityImg).toggleClass("flipped ability-on", function() {
            var element;
            action();
            checkMax();
            if (targetMon.css("display") !== "none") {
        ...
        case "aoeenemy":
          ...
          return $(".ability-img").toggleClass("aoePositionUser", function() {
            var element;
            element = $(this);
            element.finish().attr("src", callAbilityImg).toggleClass("flipped ability-on");
            $(".user.mon-slot .img").each(function() {
              if ($(this).css("display") !== "none") {
                if (battle.players[0].mons[$(this).data("index")].isAlive() === false) {
                  return $(this).effect("explode", {
                    pieces: 30
                  }, 1200).hide();
                } else {
        ...
        case "aoecleanse":
          ...
          checkMax();
          multipleTargetAbilityDisplayVariable();
          return $(".ability-img").toggleClass("aoePositionFoe", function() {
            var element;
            element = $(this);
            element.finish().attr("src", callAbilityImg).toggleClass("ability-on");
            $(".enemy.mon-slot .img").each(function() {
        ...
        case "targetally":
          ...
          action();
          checkMax();
          return abilityAnime.finish().attr("src", callAbilityImg).toggleClass("ability-on", function() {
            var element;
  ...
  $(function() {
    window.effectBin = [];
    return $.ajax($(".battle").length > 0 ? {
      url: "/battles/" + $(".battle").data("index") + ".json",
      dataType: "json",
      method: "get",
      error: function() {
        return alert("This battle cannot be loaded!");
      },
      success: function(data) {
        window.battle = data;
        if (battle.start_cut_scenes.length !== 0) {
          $(".cutscene").show(500);
          toggleImg();
        ...
        $(document).on("click.cutscene", "#overlay", function() {
          var new_index;
          if ($(".cutscene").attr("src") === battle.start_cut_scenes[battle.start_cut_scenes.length - 1]) {
            endCutScene();
            return battleStartDisplay(1000);
          } else {
        ...
        $(".battle").css({
          "background": "url(" + battle.background + ")",
        ...
        battle.round = 1;
        battle.maxAP = 40;
        battle.calculateAP = function() {
          if (battle.round < 5) {
            return battle.maxAP = 30 + 10 * battle.round;
          } else {
            return battle.maxAP = 80;
          }
        };
        ...
        battle.checkRound = function() {
          if (battle.players.every(isTurnOver)) {
            battle.round += 1;
            battle.calculateAP();
            setAll(battle.players, "turn", true);
            return setAll(battle.players, "ap", battle.maxAP);
          }
        };
        battle.monAbility = function(playerIndex, monIndex, abilityIndex, targetIndex) {
          var ability, i, monster, n, player, targets;
          ability = this.players[playerIndex].mons[monIndex].abilities[abilityIndex];
          player = this.players[playerIndex];
          monster = this.players[playerIndex].mons[monIndex];
          switch (ability.targeta) {
            case "targetenemy":
            case "attack":
          ...
          this.players[playerIndex].commandMon(monIndex, abilityIndex, targets);
          return this.checkRound();
        };
        battle.evolve = function(playerIndex, monIndex, evolveIndex) {
          var added_hp, better_mon, current_mon, evolved_hp, evolved_max_hp, evolved_mon, monDiv, new_mon, old_mon;
          current_mon = this.players[playerIndex].mons[monIndex];
          better_mon = this.players[playerIndex].mons[monIndex].mon_evols[evolveIndex];
          ...
          if (battle.players[playerIndex].ap >= better_mon.ap_cost) {
            ...
            return hpChangeBattle();
          }
        };
        $(battle.players).each(function() {
          var player;
          player = this;
          player.turn = true;
          player.commandMon = function(monIndex, abilityIndex, targets) {
            var abilityCost, mon, p;
            p = this;
            mon = p.mons[monIndex];
          ...
          return $(player.mons).each(function() {
            var monster;
            monster = this;
            monster.shield = 0;
            ...
            monster.taunted = {};
            monster.shield = {};
            monster.shield.end = void 0;
            monster.shield.true_damage = 0;
            monster.taunted.target = void 0;
            monster.team = battle.players.indexOf(player);
            monster.index = player.mons.indexOf(monster);
            return fixEvolMon(monster, player);
          });
        });
        zetBut();
        window.documentURLObject = window.battle.monAbility.toString() + window.battle.players[0].commandMon.toString() + window.battle.players[1].commandMon.toString();
        window.feed = function() {
          return targets.shift();
        };
        window.currentBut = void 0;
        toggleEnemyClick();
        $(".mon-slot .mon .img, div.mon-slot").each(function() {
          $(this).data("position", $(this).offset());
        });
        $(".ap .ap-number").text(apInfo(battle.maxAP));
        turnOnCommandA();
        $(document).on("mouseover", ".user .monBut button", function() {
          var ability, added_hp, better_mon, description, worse_mon;
          description = $(this).parent().parent().children(".abilityDesc");
          if ($(this).data("target") === "evolve") {
            ...
            description.children(".panel-body").html(better_mon.abilities[0].name + ": " + better_mon.abilities[0].description + "<br />" + "<br />" + better_mon.abilities[1].name + ": " + better_mon.abilities[1].description);
        ...
        }).on("mouseleave", ".user .monBut button", function() {
          $(this).parent().parent().children(".abilityDesc").css({
            "z-index": "-1",
            "opacity": "0"
          });
        });
        ...
        $(document).on("mouseover", ".effect", function() {
          ...
          return $("." + e.enemyDex + ".effect-info" + " " + ".panel-heading").text("Expires in" + " " + (e.end - battle.round) + " " + "turn(s)");
        }).on("mouseleave", ".effect", function() {
          var e, index;
          index = this.id;
          e = effectBin[index];
          return $("." + e.enemyDex + ".effect-info").css("visibility", "hidden");
        });
        return $(document).on("click.button", ".user.mon-slot .monBut button", function() {
          var ability, abilityAnime, betterMon, i, oldMon, targetMon;
          ...
          if (window.battle.players[0].ap >= ability.data("apcost")) {
            ...
            $(document).on("click.cancel", ".cancel", function() {
              ...
              toggleImg();
              if (ability.data("target").indexOf("ally") !== -1 || ability.data("target") === "ability") {
                toggleImg();
              }
              targets = [];
            });
            if (targets.length !== 3) {
              window.targets = targets.concat(ability.data("index"));
            }
            if (targets.length !== 0) {
              switch (ability.data("target")) {
                case "attack":
                  enemyAbilityBeforeClickDisplay();
                  return $(document).on("click.boom", ".enemy.mon-slot .img", function() {
                    var backPosition, currentPosition, leftMove, monDiv, targetMon, targetPosition, topMove;
                    ...
                    setTimeout((function() {
                      ...
                      showDamageSingle();
                      return currentMon.finish().animate(backPosition, 440);
                    }), 460);
                    return setTimeout((function() {
                      singleTargetAbilityAfterActionDisplay();
                      return toggleEnemyClick();
                    }), 1000);
                  });
                case "targetenemy":
                  enemyAbilityBeforeClickDisplay();
                  return $(document).on("click.boom", ".enemy.mon-slot .img", function() {
                    var abilityAnime, monDiv, targetMon, targetPosition;
                    singleTargetAbilityAfterClickDisplay(ability);
                    targetMon = $(this);
                    monDiv = targetMon.parent();
                    window.targets = targets.concat(monDiv.data("index"));
                ...
                case "cleanseally":
                  ...
                  return $(document).on("click.help", ".user.mon-slot .img", function() {
                    var abilityAnime, monDiv, targetMon, targetPosition;
                    toggleImg();
                    singleTargetAbilityAfterClickDisplay(ability);
                    targetMon = $(this);
                  ...
                  return $(document).on("click.boom", ".enemy.mon-slot .img", function() {
                    ...
                    return $(".ability-img").toggleClass("aoePositionFoe", function() {
                      ...
                      setTimeout((function() {
                        ...
                        $(".enemy.mon-slot .img").each(function() {
                          if ($(this).css("display") !== "none") {
                            if (battle.players[1].mons[$(this).data("index")].isAlive() === false) {
                              return $(this).css({
                                "transform": "scaleX(-1)"
                              }).effect("explode", {
                                pieces: 30
                ...
                case "evolve":
                  ...
                  abilityAnime.finish().attr("src", betterMon.animation).toggleClass("ability-on", function() {
                    $(".battle").effect("shake");
                    return targetMon.fadeOut(500, function() {
                      return $(this).finish().attr("src", betterMon.image).fadeIn(1000);
                    });
                  });
                  setTimeout((function() {
                    xadBuk();
            ...
            $(this).add(".ap").effect("highlight", {
              color: "red"
            }, 100);
            return $(".end-turn").prop("disabled", false);
          }
        });
      }
    } : void 0);
...
(function() {
  $(function() {
    $(document).on("click.filter_levels", ".map-level", function() {
      var area, area_index;
      ...
      return setTimeout((function() {
        ...
        return document.getElementsByClassName("map-level")[area_index].className += " current-area";
      }), 500);
    });
    $(document).on("click.filter_areas", ".region-select", function() {
      var i, index;
      $(".map-image, .map-level").fadeOut(300);
      setTimeout((function() {
        return $(".map-image, .map-level").fadeIn(300);
      }), 500);
      index = $(".region-select").index($(this));
      i = 0;
      while (i < document.getElementsByClassName("region-select").length) {
        document.getElementsByClassName("region-select")[i].className = document.getElementsByClassName("region-select")[i].className.replace(" current-region", "");
        i++;
      }
      document.getElementsByClassName("region-select")[index].className += " current-region";
      return $(".level-select").promise().done(function() {
        return setTimeout((function() {
          return $(".map-level").last().trigger("click");
        }), 500);
      });
    });
    return $(document).on("click.select_level", ".pick-level", function() {
...
(function() {
  $(function() {
    return $(document).on("click", ".news-entry-click", function() {
      var i;
      i = 0;
      while (i < document.getElementsByClassName("news-entry").length) {
        document.getElementsByClassName("news-entry")[i].className = document.getElementsByClassName("news-entry")[i].className.replace(" notice-selected", "");
        i++;
      }
      $(".news-detail").fadeOut(300);
      return $(this).children(".news-entry").addClass("notice-selected");
    });
  });
...
(function() {
  window.reloadObjects = function(obj, but) {
    if (window.location.href.indexOf(obj) !== -1) {
      return setTimeout((function() {
        return $(but).trigger("click");
      }), 400);
    }
  };

  window.fixTurbo = function() {
    return setTimeout((function() {
  ...
  $(function() {
    fixTurbo();
    return $(document).on("click", ".navbar.nav-admin .nav-btn-group .btn", fixTurbo);
  });

}).call(this);
(function() {
  $(function() {
    $(document).on("mouseover", ".king-roll", function() {
      return $(this).attr("src", "../assets/summon-button-mouseover.png");
    });
    $(document).on("mouseleave", ".king-roll", function() {
      return $(this).attr("src", "../assets/summon-button.png");
    });
    $.ajax({
      url: "/store",
      method: "get",
      dataType: "json",
      error: function() {
        return alert("Cannot get the latest abilities");
      },
      success: function(response) {
        return window.latest_abilities = response;
      }
    });
    $(document).on("click", ".king-roll", function() {
      $.ajax({
        url: "/home/roll_treasure",
        method: "get",
        dataType: "json",
        error: function() {
          return alert("Can't process the roll");
        },
        success: function(response) {
          var gp, message, overlay;
          ...
          return message.innerHTML = response.message;
        }
      });
      return $(document).on("click", function() {
        var overlay;
        overlay = document.getElementsByClassName("store-overlay")[0];
        return overlay.classList.remove("fadeIn-1s");
      });
    });
    return $(document).on("mouseover", ".showcase", function() {
      return $(".ability-detail").text(latest_abilities[$(this).data("index")].description);
    });
  });

}).call(this);
(function() {
  var setDonationAmount, setDonationButton;

  window.setEnergy = function() {
    var energy_seconds;
    if (document.getElementById("summoner-level") !== null) {
      energy_seconds = parseInt(document.getElementById("summoner-level").getAttribute("data-seconds"));
    }
    $(".quests-info").click(false);
    if (typeof staminaTimer !== "undefined") {
      window.clearInterval(staminaTimer);
    }
    if (typeof questTimer !== "undefined") {
      window.clearInterval(questTimer);
    }
    return setTimeout((function() {
      replenishStamina();
      return window.staminaTimer = setInterval(replenishStamina, 301000);
    }), energy_seconds * 1000);
  };

  window.replenishStamina = function() {
    var number;
    if (document.getElementById("current-stamina") !== null) {
      if (parseInt(document.getElementById("current-stamina").innerHTML) !== 100) {
        ...
        return $(".summoner-stamina-bar .bar").css("width", number.toString() + "%");
      }
    }
  };

  window.zetBut = function() {
    return $.ajax({
  ...
  window.xadBuk = function() {
    return $.ajax({
      ...
      success: function(data) {
        if (data.indexOf("fucked") !== -1) {
          return setTimeout((function() {
            return alert("You motherfucker");
          }), 500);
        }
      }
    });
  ...
  setDonationAmount = function() {
    return window.money = $(".donation").val().replace(/,/g, '') * 100;
  };

  setDonationButton = function() {
    return $(".donation-action").html("<script src='https://checkout.stripe.com/checkout.js' class='stripe-button hide' data-key='pk_test_qE72HFJsHUp6ldnoydHeWUTL' data-description= 'Donation for Monbattle' data-amount = " + money + " ></script>");
  };
  ...
  window.setQuestTimer = function() {
    return $(".quest .quest-time").each(function() {
      var number, time;
  ...
  $(function() {
    ...
    $(document).on("keyup", ".donation", function() {
      setDonationAmount();
      return setDonationButton();
    });
    $(document).on("click.donate", ".donation-click", function(event) {
      event.preventDefault();
      return $(".stripe-button-el").trigger("click");
    });
    $(document).on("click", ".quest-show", function(event) {
      event.preventDefault();
      if ($(".quests-info").css("opacity") === "0") {
        $(this).parent().addClass("active");
        $(".quests-info, .quest-arrow, .quests-outline").css("opacity", "1").css("z-index", "5000");
        return $(".quest-arrow").css("z-index", "6000");
      } else {
        $(this).parent().removeClass("active");
        return $(".quests-info, .quest-arrow, .quests-outline").css("opacity", "0").css("z-index", "-100");
      }
    });
    $(document).on("click", ".for-real, .close-quest, .quest-close-footer", function() {
      $(".quests-info, .quest-arrow, .quests-outline").css("opacity", "0").css("z-index", "-100");
      return $(".quest-show").parent().removeClass("active");
    });
    $(document).on("click.quest", ".fb-nav :not('.quest-show')", function() {
      return setTimeout((function() {
        setEnergy();
        window.questTimer = setInterval(setQuestTimer, 1000);
    ...
    return $(document).on("click.fix", ".battle-fin, .party_edit_button", function() {
      return setTimeout((function() {
        setEnergy();
        window.questTimer = setInterval(setQuestTimer, 1000);
        return console.log("sup");
